...
enum error_code {
  ...
  STREAM_MAX_VALUE,
  BITSETIO_PTR_NULL,
  BITSETIO_BITFILE_OPEN_FAILED,
  BITSETIO_BITFILE_LENGTH,
  BITSETIO_BITFILE_READ_FAILED,
  BITSETIO_BITFILE_FILEPATH_EMPTY,
  ...
  CHUNKMANAGER_BLOCKCOUNT_NOT,
  CHUNKMANAGER_CUTDOWN_BLOCKCOUNT,
